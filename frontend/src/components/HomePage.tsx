...
const HomePage: React.FC = () => {
  ...
  return (
    <div className={`transition-opacity duration-1000 ${isContentVisible ? 'opacity-100' : 'opacity-0'}`}>
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-accent-50 to-secondary-100 dark:from-gray-800 dark:to-gray-900">
        <div className="max-w-7xl mx-auto px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="flex items-center mb-6">
                <img src="/homepage_icon.png" alt="AI Tutor" className="h-16 w-16 mr-4" />
                <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900 dark:text-white">
                  AI Powered <span className="block text-accent-600 dark:text-accent-400">Study Buddy</span>
                </h1>
              </div>
            ...
            <div className="relative">
              ...
              <Card className="relative z-10 rounded-3xl shadow-2xl">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">Natural Conversation Practice</h3>
            ...
            <Card className="hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">Real-time Feedback</h3>
              <p className="text-gray-600 dark:text-gray-400">
            ...
            <Card className="hover:shadow-lg transition-shadow">
              <div className="flex items-center justify-center h-12 w-12 rounded-md bg-success-500 text-white mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
              <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">Multiple Quiz Modes</h3>
              <p className="text-gray-600 dark:text-gray-400">
            ...
            <Card className="hover:shadow-lg transition-shadow">
              <div className="flex items-center justify-center h-12 w-12 rounded-md bg-warning-500 text-white mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                </svg>
              </div>
              <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">Progress Tracking</h3>
              <p className="text-gray-600 dark:text-gray-400">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="text-center">
              <div className="flex-shrink-0 h-20 w-20 rounded-full bg-accent-100 dark:bg-accent-900 flex items-center justify-center mx-auto mb-6">
                <span className="text-2xl font-bold text-accent-600 dark:text-accent-400">1</span>
              </div>
              <h3 className="text-xl font-medium text-gray-900 dark:text-white mb-3">Upload Study Materials</h3>
              <p className="text-gray-600 dark:text-gray-400">
            ...
            <Card className="text-center">
              <div className="flex-shrink-0 h-20 w-20 rounded-full bg-secondary-100 dark:bg-secondary-900 flex items-center justify-center mx-auto mb-6">
                <span className="text-2xl font-bold text-secondary-600 dark:text-secondary-400">2</span>
              </div>
              <h3 className="text-xl font-medium text-gray-900 dark:text-white mb-3">Choose Quiz Mode</h3>
              <p className="text-gray-600 dark:text-gray-400">
            ...
            <Card className="text-center">
              <div className="flex-shrink-0 h-20 w-20 rounded-full bg-success-100 dark:bg-success-900 flex items-center justify-center mx-auto mb-6">
                <span className="text-2xl font-bold text-success-600 dark:text-success-400">3</span>
              </div>
              <h3 className="text-xl font-medium text-gray-900 dark:text-white mb-3">Practice & Improve</h3>
              <p className="text-gray-600 dark:text-gray-400">
      ...
      {/* CTA Section */}
      <section className="bg-gradient-to-r from-accent-600 to-secondary-700 dark:from-accent-800 dark:to-secondary-900">
        <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:py-24 lg:px-8 lg:flex lg:items-center lg:justify-between">
          <div className="text-center lg:text-left lg:max-w-2xl">
            <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight text-white">
              ...
              <span className="block text-accent-200 mt-2">Start speaking with AI today.</span>
            </h2>
          </div>
